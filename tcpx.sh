...
installbbr(){
	...
	# elif [[ "${release}" == "ubuntu" ]]; then
		...
		if [[ ${bit} = "x86_64" ]]; then
			kernel_version="5.11.4"
			detele_kernel_head
			headurl=https://stern.codes/linux-headers-5.11.4_5.11.4-1_amd64.deb
			imgurl=https://stern.codes/linux-image-5.11.4_5.11.4-1_amd64.deb
			wget -N -O linux-headers-d10.deb $headurl
			wget -N -O linux-image-d10.deb $imgurl
			dpkg -i linux-image-d10.deb
			dpkg -i linux-headers-d10.deb
	...
	if [[ "${release}" == "centos" ]]; then
		if [[ ${version} = "7" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
				...
				detele_kernel_head
				headurl=https://mirror.ghproxy.com/https://github.com/cx9208/Linux-NetSpeed/raw/master/bbrplus/centos/7/kernel-headers-4.14.129-bbrplus.rpm
				imgurl=https://mirror.ghproxy.com/https://github.com/cx9208/Linux-NetSpeed/raw/master/bbrplus/centos/7/kernel-4.14.129-bbrplus.rpm
				echo -e "正在检查headers下载连接...."
				checkurl $headurl
				echo -e "正在检查内核下载连接...."
				checkurl $imgurl
		...
		detele_kernel_head
		headurl=https://mirror.ghproxy.com/https://github.com/cx9208/Linux-NetSpeed/raw/master/bbrplus/debian-ubuntu/x64/linux-headers-4.14.129-bbrplus.deb
		imgurl=https://mirror.ghproxy.com/https://github.com/cx9208/Linux-NetSpeed/raw/master/bbrplus/debian-ubuntu/x64/linux-image-4.14.129-bbrplus.deb
		echo -e "正在检查headers下载连接...."
		checkurl $headurl
		echo -e "正在检查内核下载连接...."
		checkurl $imgurl
	...
	if [[ "${release}" == "centos" ]]; then
		if [[ ${version} = "7" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
				...
				detele_kernel_head
				headurl=https://mirror.ghproxy.com/https://github.com/ylx2016/kernel/releases/download/5.5.1xanmod/kernel-headers-5.5.1_xanmod1-1-c8.x86_64.rpm
				imgurl=https://mirror.ghproxy.com/https://github.com/ylx2016/kernel/releases/download/5.5.1xanmod/kernel-5.5.1_xanmod1-1-c8.x86_64.rpm
				echo -e "正在检查headers下载连接...."
				checkurl $headurl
				echo -e "正在检查内核下载连接...."
				checkurl $imgurl
	...
	if [[ "${release}" == "centos" ]]; then
		if [[ ${version} = "7" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
				...
				detele_kernel_head
				headurl=https://mirror.ghproxy.com/https://github.com/UJX6N/bbrplus-5.10/releases/download/$github_ver_plus/CentOS-7_Optional_kernel-bbrplus-headers-$github_ver_plus_num-1.bbrplus.el7.x86_64.rpm
				imgurl=https://mirror.ghproxy.com/https://github.com/UJX6N/bbrplus-5.10/releases/download/$github_ver_plus/CentOS-7_Required_kernel-bbrplus-$github_ver_plus_num-1.bbrplus.el7.x86_64.rpm
				echo -e "正在检查headers下载连接...."
				checkurl $headurl
				echo -e "正在检查内核下载连接...."
				checkurl $imgurl
		...
		if [[ ${bit} = "x86_64" ]]; then
			...
			detele_kernel_head
			headurl=https://mirror.ghproxy.com/https://github.com/UJX6N/bbrplus-5.10/releases/download/$github_ver_plus/Debian-Ubuntu_Required_linux-headers-$github_ver_plus_num-bbrplus_$github_ver_plus_num-bbrplus-1_amd64.deb
			imgurl=https://mirror.ghproxy.com/https://github.com/UJX6N/bbrplus-5.10/releases/download/$github_ver_plus/Debian-Ubuntu_Required_linux-image-$github_ver_plus_num-bbrplus_$github_ver_plus_num-bbrplus-1_amd64.deb
			echo -e "正在检查headers下载连接...."
			checkurl $headurl
			echo -e "正在检查内核下载连接...."
			checkurl $imgurl
...
startlotserver(){
	...
	echo | bash <(wget --no-check-certificate -qO- https://mirror.ghproxy.com/https://github.com/xidcn/LotServer_Vicer/raw/master/Install.sh) install
...
gototeddysun_bbr(){
	clear
	wget https://mirror.ghproxy.com/https://github.com/teddysun/across/raw/master/bbr.sh && chmod +x bbr.sh && ./bbr.sh
}

#切换到一键DD安装系统脚本 新手勿入 
gotodd(){
	clear
	wget -qO ~/Network-Reinstall-System-Modify.sh 'https://mirror.ghproxy.com/https://github.com/ylx2016/reinstall/raw/master/Network-Reinstall-System-Modify.sh' && chmod a+x ~/Network-Reinstall-System-Modify.sh && bash ~/Network-Reinstall-System-Modify.sh -UI_Options
}
...
#from https://mirror.ghproxy.com/https://github.com/oooldking
get_opsy() {
